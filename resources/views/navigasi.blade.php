...
<div class="w-full bg-dark h-[96px] drop-shadow-lg flex flex-row items-center">

    <div class="w-1/2 pr-5 pt-3 flex items-center justify-center">
        <a href="" class="font-bold text-5xl font-anton text-red-500 hover:text-develobe-500
        duration-200">
            LAYARKACA21
        </a>
    </div>

    <div class="w-10/12 pt-3 flex items-center justify-center">
    <!-- <div class="w-1/3 pt-3 flex items-center justify-end"> -->
        <!-- <a href="" class="group">
            <svg width='30' height='30' role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>SearXNG</title>
